...
public class PianaJalaliCalendar extends Calendar {
    ...
    public PianaJalaliCalendar() {
        this(TimeZone.getDefault(), Locale.getDefault());
    }

    public PianaJalaliCalendar(TimeZone zone) {
        this(zone, Locale.getDefault());
    }

    public PianaJalaliCalendar(Locale aLocale) {
        this(TimeZone.getDefault(), aLocale);
    }

    public PianaJalaliCalendar(TimeZone zone, Locale aLocale) {
    ...
    public PianaJalaliCalendar(int year, int month, int dayOfMonth) {
        this(year, month, dayOfMonth, 0, 0, 0, 0);
    }

    public PianaJalaliCalendar(int year, int month, int dayOfMonth, int hourOfDay,
                          int minute) {
    ...
    PianaJalaliCalendar(int year, int month, int dayOfMonth,
    ...
    public static int weekOfYear(int dayOfYear, int year) {
        switch (dayOfWeek(PianaJalaliCalendar.jalaliToGregorian(new YearMonthDate(year, 0, 1)))) {
            case 2:
                dayOfYear++;
                break;
            case 3:
